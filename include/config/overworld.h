...
#define OW_BERRY_MUTATION_CHANCE       15         // Determines the % chance of a mutation.
...
#define OW_BERRY_GROWTH_RATE           GEN_6      // Presets for how long each Berry plant takes to grow.
