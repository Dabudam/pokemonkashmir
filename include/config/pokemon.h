...
#define P_MOTHER_EGG_MOVE_INHERITANCE  GEN_5                // Since Gen 6, the mother can also pass down Egg Moves.
#define P_NATURE_INHERITANCE           GEN_3                // In Gen 3, Everstone grants Ditto and mothers a 50% chance to pass on Nature. Since Gen 4, anyone can pass on nature. Since Gen 5, the chance is 100%.
...
#define P_EV_CAP                         GEN_5  // Since Gen 6, the max EVs per stat is 252 instead of 255.
