...
const u32 gObjectEventPic_Damian[] = INCBIN_U32("graphics/object_events/pics/people/team_darkstone/damian.4bpp");
const u16 gObjectEventPal_Damian[] = INCBIN_U16("graphics/object_events/palettes/damian.gbapal");
